...
HD_PWD='C:/Users/griff/Median Filter/Median Filter.runs/fifo_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_buffer.tcl
