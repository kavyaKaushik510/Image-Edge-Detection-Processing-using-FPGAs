...
#
# Script generated by Vivado on Sun May 18 23:26:44 +0200 2025
...
#
# Usage        : Controller.sh
#                Controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Controller.sh [-reset_run]
#                Controller.sh [-reset_log]
#                Controller.sh [-help]
#
...
# script info
echo -e "Controller.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Controller xil_defaultlib.Controller xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Controller -key {Behavioral:sim_2:Functional:Controller} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Controller.wdb xsim.dir libdpi.so)
...
Usage: Controller.sh [-step]\n\
Usage: Controller.sh [-lib_map_path]\n\
Usage: Controller.sh [-reset_run]\n\
Usage: Controller.sh [-reset_log]\n\
Usage: Controller.sh [-keep_index]\n\
